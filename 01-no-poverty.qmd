# No Poverty {#sec-sdg01}

![](images/icons/E-WEB-Goal-01.png){.sdg-icon}
...
```{r}
#| echo: false
write_csv(pip_gini_2010, "data/01/pip_gini_2010.csv")
```

- [pip_gini_2010.csv](data/01/pip_gini_2010.csv){download=""}

```{r}
#| echo: false
#| label: tbl-pip_gini_2010
#| tbl-cap: The first rows of pip_gini_2010
head(pip_gini_2010)
```
...
```{r}
#| echo: false
write_csv(pip_welfare_2010, "data/01/pip_welfare_2010.csv")
```

- [pip_welfare_2010.csv](data/01/pip_welfare_2010.csv){download=""}

```{r}
#| echo: false
#| label: tbl-pip_welfare_2010
#| tbl-cap: The first rows of pip_welfare_2010
head(pip_welfare_2010)
```
...
```{r}
#| echo: false
write_csv(pip_gini_usa, "data/01/pip_gini_usa.csv")
write_csv(pip_gini_china, "data/01/pip_gini_china.csv")
write_csv(pip_gini_uk, "data/01/pip_gini_uk.csv")
```

- [pip_gini_china.csv](data/01/pip_gini_china.csv){download=""}
- [pip_gini_uk.csv](data/01/pip_gini_uk.csv){download=""}
- [pip_gini_usa.csv](data/01/pip_gini_usa.csv){download=""}

```{r}
#| echo: false
#| label: tbl-pip_gini_china
#| tbl-cap: The first rows of pip_gini_china
head(pip_gini_china)
```
