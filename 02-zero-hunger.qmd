...
```{r}
#| echo: false
write_csv(ghi_2024, "data/02/ghi_2024.csv")
```
...
#| echo: false
#| label: tbl-ghi_2024
#| tbl-cap: The first rows of ghi_2024
head(ghi_2024)
```
...
```{r}
#| echo: false
write_csv(ghi_long, "data/02/ghi_long.csv")
```

* [ghi_long.csv](data/02/ghi_long.csv)

```{r}
#| echo: false
#| label: tbl-ghi_long
#| tbl-cap: The first rows of ghi_long
head(ghi_long)
```
...
```{r}
#| echo: false
write_csv(ghi_indicators, "data/02/ghi_indicators.csv")
```
...
* [ghi_indicators.csv](data/02/ghi_indicators.csv)

```{r}
#| echo: false
#| label: tbl-ghi_indicators
#| tbl-cap: The first rows of ghi_indicators
head(ghi_indicators)
```
