...
* [measles.xlsx](data/03/measles.xlsx)
* [rubella.xlsx](data/03/rubella.xlsx)
...
```{r}
#| echo: false
write_csv(measles_coverage, "data/03/measles-coverage.csv")
write_csv(rubella_coverage, "data/03/rubella-coverage.csv")
```

These data sets are good for practicing data merging and dealing with missing data.

- [measles-coverage.csv](data/01/measles-coverage.csv){download=""}
- [rubella-coverage.csv](data/01/rubella-coverage.csv){download=""}
